...
export const DEMO_STORE: Store = {
  ...
  // Forward-compatible field only (see StoredLensSession in types.ts) —
  // nothing in the current product reads this yet, so demo content has
  // nothing to populate here beyond the required empty array.
  lensSessions: [],
};
