...
export const DEMO_STORE: Store = {
  ...
  beliefs: [
    ...
    { id: "demo-belief-2", domain: "Relationships", statement: "It's better to do things alone", confidence: 57, evidenceCount: 18, evidenceQuotes: [], status: "emerging", thoughtLabel: "Distancing thought", supportingEntryIds: ["demo-entry-2"], lastUpdatedAt: "2026.07.21" },
  ...
  proPlan: "yearly",
  goals: [
    { id: "demo-goal-0", statement: "Let one thing stay imperfect on purpose, and start it anyway.", basedOnDomains: ["Work", "Career"], createdDate: "2026.07.20" },
    { id: "demo-goal-1", statement: "Ask for help with something before you've exhausted doing it alone.", basedOnDomains: ["Relationships"], createdDate: "2026.07.20" },
    { id: "demo-goal-2", statement: "Notice one choice this week you made for freedom, not just security.", basedOnDomains: ["Values", "Life overall"], createdDate: "2026.07.20" },
  ],
