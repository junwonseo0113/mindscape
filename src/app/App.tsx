...
function ScreenHome({ onNavSelect, onStartThink, onOpenBrainMap, store }: { onNavSelect?: (id: string) => void; onStartThink?: () => void; onOpenBrainMap?: (region?: CognitiveRegion) => void; store: Store }) {
  return (
    <div
      style={{
        display: "flex", flexDirection: "column", backgroundColor: vtgDusk,
        ...
        // slot instead. Safe against clipping (unlike a negative margin on
        // a child inside the scrollable div below, which an overflow:auto
        // container can permanently swallow): this shift happens on the
        // whole component, one level above any scrolling, well inside the
        // frame's own rounded-corner clip.
    ...
    >
      <div style={{ flex: 1, minHeight: 0, overflowY: "auto", padding: "0 20px 20px" }}>
        <div
          style={{
            position: "relative", marginLeft: -20, marginRight: -20, aspectRatio: HOME_HERO_ASPECT,
            ...
            // top since the photo starts right at the very top of the
            // screen, nothing behind it to blend into.
        ...
        >
          ...
          "9:41" overlay (see the App shell) regardless of how tall the
          hero photo itself renders at. */}
